...
contract TiecketMaster is ERC721 {
    ...
    function mint(uint256 _id, uint256 _seat) public payable {
        ...
        require(_id != 0, "No ID found");
        require(_id <= totalOccasions, "Not valid ID");

        // Require that ETH snd is greater than cost
        require(msg.value >= occasions[_id].cost, "Insufficient balance");
